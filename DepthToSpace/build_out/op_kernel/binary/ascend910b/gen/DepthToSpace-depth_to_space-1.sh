...
opc $1 --main_func=depth_to_space --input_param=/home/ma-user/work/suanzi/DepthToSpace/build_out/op_kernel/binary/ascend910b/gen/DepthToSpace_e6bf23fc63f778673bc55c996c450bbd_param.json --soc_version=Ascend910B1 --output=$2 --impl_mode="" --simplified_key_mode=0 --op_mode=dynamic
