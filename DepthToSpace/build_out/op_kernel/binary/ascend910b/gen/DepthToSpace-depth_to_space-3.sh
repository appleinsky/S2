...
opc $1 --main_func=depth_to_space --input_param=/home/ma-user/work/suanzi/DepthToSpace/build_out/op_kernel/binary/ascend910b/gen/DepthToSpace_7064a90832aab6ac5a56e78dd7552482_param.json --soc_version=Ascend910B1 --output=$2 --impl_mode="" --simplified_key_mode=0 --op_mode=dynamic
