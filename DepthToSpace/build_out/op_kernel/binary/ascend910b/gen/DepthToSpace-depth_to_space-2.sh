...
opc $1 --main_func=depth_to_space --input_param=/home/ma-user/work/suanzi/DepthToSpace/build_out/op_kernel/binary/ascend910b/gen/DepthToSpace_6dfe58a9254e52a57c75cf8bf0a0d5e9_param.json --soc_version=Ascend910B1 --output=$2 --impl_mode="" --simplified_key_mode=0 --op_mode=dynamic
